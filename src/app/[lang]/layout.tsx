...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  // console.log(`[generateMetadata] Langue actuelle : ${lang}`); 
  ...
  try {
    ...
    console.error(`[generateMetadata] Erreur pour la langue ${lang}:`, error);
    return {
      title: "Vibecodr", 
      description: "Build your digital product with AI and human expertise.",
    };
  }
}
