      ...
      <div className="container mx-auto relative z-10">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-1 border border-gray-100 dark:border-gray-700/50 overflow-hidden transition-shadow hover:shadow-3xl">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h4 className="ml-4 text-base font-semibold text-indigo-600 dark:text-indigo-300">{t('interfaceMockup.title')}</h4>
                </div>
                {/* Ligne de titre */}
                <div className="flex justify-between items-center">
                  <div className="h-6 w-3/4 bg-gray-100 dark:bg-gray-700 rounded-md"></div>
                ...
                <div className="flex gap-2 my-3">
                  <span className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 rounded-full text-xs text-purple-600 dark:text-purple-300 font-medium shadow-sm hover:bg-purple-200 transition">{t('interfaceMockup.tagVisionFirst')}</span>
                  <span className="px-3 py-1 bg-pink-100 dark:bg-pink-900/30 rounded-full text-xs text-pink-600 dark:text-pink-300 font-medium shadow-sm hover:bg-pink-200 transition">{t('interfaceMockup.tagSaaS')}</span>
                  <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 rounded-full text-xs text-blue-600 dark:text-blue-300 font-medium shadow-sm hover:bg-blue-200 transition">{t('interfaceMockup.tagMVP')}</span>
                </div>
                {/* Bloc d'analyse IA */}
                <div className="h-48 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg border border-indigo-100 dark:border-indigo-800/30 p-4 flex flex-col justify-between shadow-inner">
                  <div className="flex justify-between items-center mb-3">
                    <span className="font-medium text-indigo-700 dark:text-indigo-300 text-sm flex items-center gap-1">
                      <LineChart className="h-4 w-4" />
                      {t('interfaceMockup.iaAnalysisTitle')}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-center text-indigo-600 dark:text-indigo-300 text-sm font-medium">{t('interfaceMockup.iaAnalysisSubtitle')}</span>
